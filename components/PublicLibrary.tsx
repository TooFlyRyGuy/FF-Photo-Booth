  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <header className="bg-white border-b-2 border-slate-200 sticky top-0 z-30">
        ...
        <div className="sm:hidden px-3 pt-3 pb-2 flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="relative flex items-center gap-1.5 bg-green-700 hover:bg-green-800 text-white px-2.5 py-1.5 rounded-lg text-xs font-semibold transition-colors shrink-0"
            >
              <ShoppingCart size={15} />
              <span>Cart</span>
              {cart.length > 0 && (
                <span className="absolute -top-1.5 -right-1.5 bg-red-500 text-white text-xs rounded-full w-4 h-4 flex items-center justify-center font-bold leading-none text-[10px]">
                  {cart.length}
                </span>
              )}
            </button>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-lg border-2 text-xs font-semibold transition-colors shrink-0 ${
                hasActiveFilters
        ...
        {/* Desktop layout: single row logo + title + actions, then search row */}
        <div className="hidden sm:block">
          <div className="px-6 lg:px-8 pt-2.5 pb-2 flex items-center gap-3">
            <a href="https://funframephoto.com" target="_blank" rel="noopener noreferrer" className="shrink-0">
              <img
                src="https://funframephoto.com/assets/images/logo.png"
                alt="Fun Frame Photo"
            ...
            <button
              onClick={() => setCartOpen(true)}
              className="relative flex items-center gap-1.5 bg-green-700 hover:bg-green-800 text-white px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors shrink-0"
            >
              <ShoppingCart size={15} />
              <span>Cart</span>
              {cart.length > 0 && (
          ...
          {/* Search + filter */}
          <div className="px-6 lg:px-8 pb-2.5 flex gap-2">
            <div className="relative flex-1">
              <Search size={14} className="absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400" />
              <input
                type="text"
